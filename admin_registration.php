					...
					<div class="container making_straight">
						<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-md-4"><input type="submit" class="form-control btn-success" name="admin_register" value="Register"></div>
							</div>
						</div>
					</div>
				</form>
...
<?php
	if(isset($_POST['admin_register'])){
		...
		$pass=sha1(htmlspecialchars($_POST['pwd']));
		$mobile_number=htmlspecialchars($_POST['mobile_number']);
		$email=htmlspecialchars($_POST['eml']);
		$role_1 = $_POST['role_1'];
		

		$sql = "INSERT INTO register(name,address,password,mobile_number,email,role) VALUES ('$name','$address','$pass','$mobile_number','$email','$role_1')";

		if (mysqli_query($conn, $sql)) {
			$last_id = mysqli_insert_id($conn);
			$sql_1 = "INSERT INTO admin_register(added_id,own_id) VALUES ('".$last_id."','".$_SESSION["user_id_session"]."')";
			if (mysqli_query($conn, $sql_1)) {
				echo "<script type='text/javascript'>
					alert('Admin Profile Created Sucessfully');
					window.location.href = '/official_Tybsc_project/dashboard.php';
					</script>";
			}
		} else {
